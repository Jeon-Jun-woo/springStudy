    ...
    <table class="table">
     <tr>
       <td width="30%" class="text-center" rowspan="8">
        <img src="http://www.menupan.com${vo.poster }" style="width: 290px;height: 400px">
       </td>
       <td colspan="2">
   	     	     ...
   	     	     <form method="post" action="../reply/reply_update.do">
   	               ...
   	               <input type=hidden name=no value="${rvo.no }">
   	      	       <textarea rows="4" cols="65" name="msg" style="float: left">${rvo.msg }</textarea>
   	           	   <button class="btn-primary" style="width: 100px;height: 86px;float: left">댓글수정</button>
   	             </form>
   	     	   </td>
   	     	 </tr>
   	     	</table>
   	    ...
   	    <td>
   	      <form method="post" action="../reply/reply_insert.do">
   	         <input type=hidden name=fno value="${vo.fno }">
   	      	 ...
   	      	 <button class="btn-primary" style="width: 100px;height: 86px;float: left">댓글쓰기</button>
   	      </form>
   	    </td>
   	  </tr>
   	 </table>
